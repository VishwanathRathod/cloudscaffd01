...
<div class="bg-light border-right" id="sidebar-wrapper">
  ...
  <div class="list-group ">
    ...
    <a href="<@ofbizUrl>productAPC</@ofbizUrl>" class="list-group-item list-group-item-action <#if currentViewId == 'PRODUCT_APC'>active</#if>"><i class="material-icons">account_tree</i> APC</a>
