<div class="dashboard-widget" style="padding-top: 15px;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <div class="card  mb-3" style="height: 10rem;background-color: #fbfbfb;">
            ...
            <div class="col-sm-6">
                <div class="card  mb-3" style="height: 10rem;background-color: #fbfbfb;">
                    <div class="card-body card-padding">
                        <h6 class="card-title text-center">Reports <img src="../static/images/icon/report.png"
                                                                        class="float-right "
                                                                        style="width: 45px; margin-left: 20px;"></h6>
                    </div>
                </div>
